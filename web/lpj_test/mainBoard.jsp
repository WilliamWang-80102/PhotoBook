     ...
     <head>
         ...
         <style type="text/css">
             ...
             #viewWrapper {
                 ...
                 left: 0px;
                 overflow: hidden;
                 background: url(table.jpg) no-repeat 0 0;
		...
		<link rel="stylesheet" href="style.css" type="text/css" media="all">
         ...
         <script type="text/javascript" src="bookTurn.js"></script>
     </head>
     ...
     <input class="button2" type="button" onclick="changeView('#illustration')" value="插图" />
         ...
         <div id="viewWrapper">
             ...
             <table border="2px">
                 ...
                 <tr>
                     <td height="200px">
                         <img src="1.jpg" style="max-width:100%;max-height:100%" draggable="true" ondragstart="drag(event)" id="1" />
                     </td>
                 </tr>
                 <tr>
                     <td height="200px">
                         <img src="2.jpg" style="max-width:100%;max-height:100%" draggable="true" ondragstart="drag(event)" id="2" />
                     </td>
                 </tr>
                 <tr>
                     <td height="200px">
                         <img src="3.jpg" style="max-width:100%;max-height:100%" draggable="true" ondragstart="drag(event)" id="3" />
                     </td>
                 </tr>
                 <tr>
                     <td height="200px">
                         <img src="4.jpg" style="max-width:100%;max-height:100%" draggable="true" ondragstart="drag(event)" id="4" />
                     </td>
                 </tr>
                 <tr>
                     <td height="200px">
                         <img src="5.jpg" style="max-width:100%;max-height:100%" draggable="true" ondragstart="drag(event)" id="5" />
                     </td>
                 </tr>
                 --%>
                 ...
                 <table border="2px">
                     ...
                     <tr>
                         <td height="100px" width="100px">
                             <img src="chatu/biaoqing1.png" style="max-width:100%;max-height:100%" draggable="true" ondragstart="drag(event)" id="aa" />
                         </td>
                         <td height="100px" width="100px">
                             <img src="chatu/biaoqing2.png" style="max-width:100%;max-height:100%" draggable="true" ondragstart="drag(event)" id="ab" />
                         </td>
                         <td height="100px" width="100px">
                             <img src="chatu/biaoqing3.png" style="max-width:100%;max-height:100%" draggable="true" ondragstart="drag(event)" id="ac" />
                         </td>
                     </tr>
                     <tr>
                         <td height="100px" width="100px">
                             <img src="chatu/biaoqing4.png" style="max-width:100%;max-height:100%" draggable="true" ondragstart="drag(event)" id="ad" />
                         </td>
                         <td height="100px" width="100px">
                             <img src="chatu/biaoqing5.png" style="max-width:100%;max-height:100%" draggable="true" ondragstart="drag(event)" id="ae" />
                         </td>
                         <td height="100px" width="100px">
                             <img src="chatu/biaoqing6.png" style="max-width:100%;max-height:100%" draggable="true" ondragstart="drag(event)" id="af" />
                         </td>
                     </tr>
                     <tr>
                         <td height="100px" width="100px">
                             <img src="chatu/biaoqing7.png" style="max-width:100%;max-height:100%" draggable="true" ondragstart="drag(event)" id="ag" />
                         </td>
                         <td height="100px" width="100px">
                             <img src="chatu/biaoqing8.png" style="max-width:100%;max-height:100%" draggable="true" ondragstart="drag(event)" id="ah" />
                         </td>
                         <td height="100px" width="100px">
                             <img src="chatu/biaoqing9.png" style="max-width:100%;max-height:100%" draggable="true" ondragstart="drag(event)" id="ai" />
                         </td>
                     </tr>
                     --%>
                     <tr>
